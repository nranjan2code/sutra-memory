...
use crate::theme::*;
use crate::types::{BatchProgress, ExportFormat, ExportOptions, ImportMode, ImportPreview};
    ...
    fn render_export_tab(&mut self, ui: &mut egui::Ui, action: &mut Option<ExportImportAction>) {
        egui::Frame::none()
            ...
            .show(ui, |ui| {
                        ...
                        egui::Frame::none()
                            ...
                            .show(ui, |ui| {
                                if ui
                                    .add(
                                        egui::Label::new(
                                            RichText::new(format.name()).size(12.0).color(
                ...
                ui.checkbox(
                    &mut self.export_options.include_metadata,
                ...
                ui.horizontal(|ui| {
                    ...
                    ui.add(
                        egui::Slider::new(&mut self.export_options.min_confidence, 0.0..=1.0)
                            .show_value(true),
                    );
                });
                ...
                ui.horizontal(|ui| {
                    if ui
                        .button(RichText::new("📁 Choose Location...").size(13.0))
                        .clicked()
                    {
                        // In a real app, this would open a file dialog
                        self.export_path = format!(
                            "~/Documents/sutra_export.{}",
                ...
                if ui
                    .add_enabled(
                        ...
                        egui::Button::new(
                            RichText::new("⬇ Export").size(14.0).color(Color32::WHITE),
                        )
                        .fill(PRIMARY)
                ...
                if let Some(result) = &self.last_export_result {
                    ...
                    ui.label(
                        RichText::new(format!("{} {}", icon, result.message))
                            .size(12.0)
                            .color(color),
                    );
                }
    ...
    fn render_import_tab(&mut self, ui: &mut egui::Ui, action: &mut Option<ExportImportAction>) {
        egui::Frame::none()
            ...
            .show(ui, |ui| {
                ...
                ui.horizontal(|ui| {
                    if ui
                        .button(RichText::new("📁 Choose File...").size(13.0))
                        .clicked()
                    {
                        // In a real app, this would open a file dialog
                ...
                // Options
                ui.checkbox(
                    &mut self.validate_before_import,
                ...
                if let Some(preview) = &self.import_preview {
                    egui::Frame::none()
                        ...
                        .show(ui, |ui| {
                            ...
                            ui.add_space(4.0);
                            ui.label(
                                RichText::new(format!("Concepts: {}", preview.concepts_count))
                                    .size(12.0)
                                    .color(TEXT_PRIMARY),
                            );
                            ui.label(
                                RichText::new(format!("Edges: {}", preview.edges_count))
                                    .size(12.0)
                                    .color(TEXT_PRIMARY),
                            );
                            ui.label(
                                RichText::new(format!(
                                    "New: {}, Duplicates: {}",
                                    preview.new_count, preview.duplicates_count
                                ))
                                .size(12.0)
                                .color(TEXT_SECONDARY),
                            );
                ...
                if ui
                    .add_enabled(
                        ...
                        egui::Button::new(
                            RichText::new("⬆ Import").size(14.0).color(Color32::WHITE),
                        )
                        .fill(SUCCESS)
                        .min_size(Vec2::new(120.0, 36.0)),
                    )
