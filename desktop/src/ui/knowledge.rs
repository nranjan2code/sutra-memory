...
use crate::theme::{ACCENT, BG_WIDGET, PRIMARY, SUCCESS, TEXT_MUTED, TEXT_PRIMARY};
...
impl KnowledgePanel {
        ...
        ui.vertical(|ui| {
            ...
            ui.horizontal(|ui| {
                ...
                ui.with_layout(egui::Layout::right_to_left(egui::Align::Center), |ui| {
                    ...
                    // Count
                    ui.label(
                        RichText::new(format!("{} concepts", self.concepts.len()))
                            .size(12.0)
                            .color(TEXT_MUTED),
                    );
                });
            ...
            egui::Window::new("Delete Concept")
                ...
                .show(ui.ctx(), |ui| {
                    ui.vertical_centered(|ui| {
                        ui.add_space(8.0);
                        ui.label(
                            RichText::new("Are you sure you want to delete this concept?")
                                .size(16.0),
                        );
                        ui.label(
            ...
            .show(ui, |ui| {
                for (i, concept) in self.concepts.iter().enumerate() {
                    ...
                    response.context_menu(|ui| {
                        if ui
                            .button(RichText::new("🗑 Delete").color(crate::theme::ERROR))
                            .clicked()
                        {
            ...
            .show(ui, |ui| {
                ui.horizontal(|ui| {
                    ...
                    ui.vertical(|ui| {
                        ...
                        ui.horizontal(|ui| {
                            ui.label(
                                RichText::new(format!("ID: {}", &concept.id[..8]))
                                    .size(11.0)
                                    .color(TEXT_MUTED),
                            );
                            ui.add_space(12.0);
            ...
            .show(ui, |ui| {
                ...
                ui.vertical(|ui| {
                    ...
                    ui.horizontal(|ui| {
                        ...
                        ui.label(
                            RichText::new(format!("{}%", (concept.confidence * 100.0) as u8))
                                .size(11.0)
                                .color(conf_color),
                        )
                        ...
                        if !concept.neighbors.is_empty() {
                            ui.label(
                                RichText::new(format!("🔗 {}", concept.neighbors.len()))
                                    .size(11.0)
                                    .color(TEXT_MUTED),
                            )
    ...
    fn empty_state(&self, ui: &mut egui::Ui) -> Option<KnowledgeAction> {
        ...
        ui.vertical_centered(|ui| {
            ...
            ui.label(
                RichText::new("Start learning by going to Chat and typing:")
                    .size(13.0)
                    .color(TEXT_MUTED),
            );
            ui.add_space(12.0);
            ...
            egui::Frame::none()
                ...
                .show(ui, |ui| {
                    ui.label(
                        RichText::new("/learn The sky is blue")
                            .size(12.0)
                            .color(TEXT_PRIMARY)
                            .monospace(),
                    );
