...
class ReasoningEngineConfigBuilder:
    ...
    def with_storage_path(self, path: str, use_rust: bool = True) -> 'ReasoningEngineConfigBuilder':
        """
    ...
    def with_entity_cache(self, enabled: bool = False) -> 'ReasoningEngineConfigBuilder':
        """
